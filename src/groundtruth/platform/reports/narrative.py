...
output is then passed through :func:`~groundtruth.contracts.grounding.enforce_grounding`.
...
from groundtruth.contracts.types import VerdictLabel
    ...
    *,
    ...
    Args:
        ...
        narrator: Optional object with a ``complete(system, user) -> str`` method
            (see :mod:`groundtruth.platform.reports.providers`). When ``None``, the
